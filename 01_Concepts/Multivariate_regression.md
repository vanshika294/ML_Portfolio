...
In univariate regression, we work on scenarios where we only have one dependent and one independent variable.
...
The equation for the above case would look like this:
...
So, essentially in multivariate regression, we find the best fitting flat surface in higher dimensions.
